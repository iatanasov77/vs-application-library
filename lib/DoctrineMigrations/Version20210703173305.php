 ...
 */
final class Version20210703173305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSCMS_Pages ADD multipage_toc_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE VSCMS_Pages ADD CONSTRAINT FK_345A075AE24B3F6 FOREIGN KEY (multipage_toc_id) REFERENCES VSCMS_MultiPageToc (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSCMS_Pages DROP multipage_toc_id');
