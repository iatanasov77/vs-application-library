 ...
 */
final class Version20250317111642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE   VSUM_Users_AllowedRoles ADD CONSTRAINT FK_4EB82A2AD60322AC FOREIGN KEY (role_id) REFERENCES VSUM_UserRoles (id)');
