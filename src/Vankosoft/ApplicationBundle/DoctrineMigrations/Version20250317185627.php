 ...
 */
final class Version20250317185627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE VSUM_Users_AllowedRoles (user_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_9B2FB047A76ED395 (user_id), INDEX IDX_9B2FB047D60322AC (role_id), PRIMARY KEY(user_id, role_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
