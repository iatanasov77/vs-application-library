 ...
 */
final class Version20260422060751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE VSAPP_Applications (title VARCHAR(255) NOT NULL, hostname VARCHAR(255) DEFAULT NULL, code VARCHAR(255) NOT NULL, enabled TINYINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_7797295A77153098 (code), INDEX IDX_7797295AE551C011 (hostname), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Applications_Users (application_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_4F97A75D3E030ACD (application_id), INDEX IDX_4F97A75DA76ED395 (user_id), PRIMARY KEY (application_id, user_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_CookieConsentTranslations (language_code VARCHAR(8) NOT NULL, locale_code VARCHAR(8) DEFAULT \'en_US\' NOT NULL COMMENT \'From wich of Locales is this Language Created.\', btn_accept_all VARCHAR(64) NOT NULL, btn_reject_all VARCHAR(64) NOT NULL, title VARCHAR(64) NOT NULL, description LONGTEXT NOT NULL, label VARCHAR(64) DEFAULT \'Cookie Consent\' NOT NULL, btn_accept_necessary VARCHAR(64) DEFAULT \'Accept necessary\' NOT NULL, btn_show_preferences VARCHAR(64) DEFAULT \'Manage individual preferences\' NOT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_F761D537451CDAD4 (language_code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_InstalationInfo (version VARCHAR(12) NOT NULL, data JSON NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Locale (active TINYINT DEFAULT NULL, title VARCHAR(64) DEFAULT NULL, code VARCHAR(12) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_3DB0A7DB77153098 (code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_LogEntries (action VARCHAR(8) NOT NULL, logged_at DATETIME NOT NULL, object_id VARCHAR(64) DEFAULT NULL, object_class VARCHAR(191) NOT NULL, version INT NOT NULL, data JSON DEFAULT NULL, username VARCHAR(191) DEFAULT NULL, locale VARCHAR(8) NOT NULL, id INT AUTO_INCREMENT NOT NULL, INDEX versions_lookup_idx (object_class, object_id), UNIQUE INDEX versions_lookup_unique_idx (object_class, object_id, version, locale), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Settings (theme VARCHAR(255) DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, application_id INT DEFAULT NULL, INDEX IDX_4A491FD3E030ACD (application_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_TagsWhitelistContexts (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_AD13B59BDE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_TagsWhitelistTags (tag VARCHAR(32) NOT NULL, id INT AUTO_INCREMENT NOT NULL, context_id INT DEFAULT NULL, INDEX IDX_CC268F106B00C1CF (context_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_TaxonImage (type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, INDEX IDX_E31A81167E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_TaxonTranslations (locale VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, INDEX IDX_AFE16CB02C2AC5D3 (translatable_id), UNIQUE INDEX slug_uidx (locale, slug), UNIQUE INDEX VSAPP_TaxonTranslations_uniq_trans (translatable_id, locale), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Taxonomy (code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, root_taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1CF3890577153098 (code), UNIQUE INDEX UNIQ_1CF38905A54E9E96 (root_taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Taxons (code VARCHAR(255) NOT NULL, tree_left INT NOT NULL, tree_right INT NOT NULL, tree_level INT NOT NULL, position INT DEFAULT NULL, enabled TINYINT NOT NULL, id INT AUTO_INCREMENT NOT NULL, tree_root INT DEFAULT NULL, parent_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_2661B30B77153098 (code), INDEX IDX_2661B30BA977936C (tree_root), INDEX IDX_2661B30B727ACA70 (parent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Translations (locale VARCHAR(8) NOT NULL, object_class VARCHAR(191) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content LONGTEXT DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, INDEX translations_lookup_idx (locale, object_class, foreign_key), UNIQUE INDEX lookup_unique_idx (locale, object_class, field, foreign_key), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_WidgetGroups (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_A6E1C666DE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Widgets (code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, allow_anonymous TINYINT DEFAULT 0 NOT NULL, active TINYINT DEFAULT 1 NOT NULL, id INT AUTO_INCREMENT NOT NULL, group_id INT NOT NULL, UNIQUE INDEX UNIQ_72F1C48A77153098 (code), INDEX IDX_72F1C48AFE54D947 (group_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_Widgets_Roles (widget_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_37D65906FBE885E2 (widget_id), INDEX IDX_37D65906D60322AC (role_id), PRIMARY KEY (widget_id, role_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSAPP_WidgetsRegistry (config JSON NOT NULL, id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_93AB24C57E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_BannerImages (type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_317C4867E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_BannerPlaces (imagine_filter VARCHAR(255) NOT NULL, id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1DA716B9DE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Banners (title VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, published TINYINT NOT NULL, priority INT DEFAULT 0 NOT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Banners_Places (banner_id INT NOT NULL, place_id INT NOT NULL, INDEX IDX_61CCBD18684EC833 (banner_id), INDEX IDX_61CCBD18DA6A219 (place_id), PRIMARY KEY (banner_id, place_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_DocumentCategories (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_E0054AF0DE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Documents (title VARCHAR(255) NOT NULL, id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, toc_root_page_id INT NOT NULL, INDEX IDX_E15A147F12469DE2 (category_id), UNIQUE INDEX UNIQ_E15A147FB4CE9742 (toc_root_page_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_FileManager (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8B912DE4DE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_FileManagerFile (type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, INDEX IDX_57157B017E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_HelpCenterQuestions (question VARCHAR(255) NOT NULL, answer LONGTEXT NOT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_PageCategories (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, taxon_id INT DEFAULT NULL, INDEX IDX_98A43648727ACA70 (parent_id), UNIQUE INDEX UNIQ_98A43648DE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Pages (published TINYINT NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, tags VARCHAR(255) DEFAULT \'\', text LONGTEXT NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_345A075A989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Pages_Categories (page_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_88D3BD76C4663E4 (page_id), INDEX IDX_88D3BD7612469DE2 (category_id), PRIMARY KEY (page_id, category_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_QuickLinks (published TINYINT NOT NULL, link_text VARCHAR(255) NOT NULL, link_path VARCHAR(255) NOT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_Sliders (id INT AUTO_INCREMENT NOT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_D9BD32AFDE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_SlidersItems (active TINYINT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, url VARCHAR(255) DEFAULT NULL, position INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, slider_id INT DEFAULT NULL, INDEX IDX_15F6ED312CCC9638 (slider_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_SlidersItemsPhotos (type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_A9581A697E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSCMS_TocPage (slug VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, text LONGTEXT DEFAULT NULL, position INT DEFAULT NULL, tree_left INT NOT NULL, tree_right INT NOT NULL, tree_level INT NOT NULL, id INT AUTO_INCREMENT NOT NULL, tree_root INT DEFAULT NULL, parent_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_6B1FF241989D9B62 (slug), INDEX IDX_6B1FF241A977936C (tree_root), INDEX IDX_6B1FF241727ACA70 (parent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_AvatarImage (type VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT \'\' NOT NULL COMMENT \'The Original Name of the File.\', id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, UNIQUE INDEX UNIQ_D917FB667E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_ResetPasswordRequests (selector VARCHAR(255) NOT NULL, hashedToken VARCHAR(255) NOT NULL, requestedAt DATETIME NOT NULL, expiresAt DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, INDEX IDX_D6C66D0A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_UserRoles (role VARCHAR(255) NOT NULL, id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, taxon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_7F8AAD7E57698A6A (role), INDEX IDX_7F8AAD7E727ACA70 (parent_id), UNIQUE INDEX UNIQ_7F8AAD7EDE13F470 (taxon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_Users (salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles_array JSON NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, prefered_locale VARCHAR(255) DEFAULT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, verified TINYINT DEFAULT NULL, enabled TINYINT DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, info_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_CAFDCD035D8BC1F8 (info_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_Users_Roles (user_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_82E26E77A76ED395 (user_id), INDEX IDX_82E26E77D60322AC (role_id), PRIMARY KEY (user_id, role_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_Users_AllowedRoles (user_id INT NOT NULL, role_id INT NOT NULL, INDEX IDX_9B2FB047A76ED395 (user_id), INDEX IDX_9B2FB047D60322AC (role_id), PRIMARY KEY (user_id, role_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_UsersActivities (activity VARCHAR(255) NOT NULL, date DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, INDEX IDX_54103277A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_UsersInfo (title ENUM(\'mr\', \'mrs\', \'miss\'), first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, designation VARCHAR(255) DEFAULT NULL, birthday DATETIME DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, occupation VARCHAR(255) DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE VSUM_UsersNotifications (notification_from VARCHAR(255) NOT NULL, notification VARCHAR(255) NOT NULL, notification_body LONGTEXT DEFAULT NULL, readed TINYINT DEFAULT NULL, date DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, INDEX IDX_8D75FA15A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE VSUM_Users_AllowedRoles ADD CONSTRAINT FK_9B2FB047A76ED395 FOREIGN KEY (user_id) REFERENCES VSUM_Users (id)');
        $this->addSql('ALTER TABLE VSUM_Users_AllowedRoles ADD CONSTRAINT FK_9B2FB047D60322AC FOREIGN KEY (role_id) REFERENCES VSUM_UserRoles (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VSUM_Users_AllowedRoles DROP FOREIGN KEY FK_9B2FB047A76ED395');
        $this->addSql('ALTER TABLE VSUM_Users_AllowedRoles DROP FOREIGN KEY FK_9B2FB047D60322AC');
